  ...
  return (
    <div>
      ...
      <div className="border border-slate-200 rounded-lg p-4 mb-4 space-y-5">
        <div>
          <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-2">1. className với template literals</p>
          <div
        ...
        <div>
          <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-2">2. className với ternary</p>
          <div
        ...
        <div>
          <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-2">3. style object (camelCase)</p>
          <p
      ...
      <div className="p-4 bg-slate-50 rounded">
        ...
        <div className="text-sm text-slate-600 space-y-2">
          <p>
            <strong>className luôn là string — không có object/array syntax.</strong> React dùng{' '}
            <code className="bg-slate-200 px-1 rounded">className</code> (không phải{' '}
            <code className="bg-slate-200 px-1 rounded">class</code>). Phải tự build string bằng
            template literals hoặc library như{' '}
          ...
          <p>
            ...
            <code className="bg-slate-200 px-1 rounded">font-size</code>. Không auto-prefix vendor
            prefixes — phải thêm thủ công (hoặc dùng CSS-in-JS library).
          </p>
          <p>
            <strong>Vue có :class object/array syntax built-in</strong> → compile away tại build
            time, không có runtime overhead. React template literals được evaluate runtime mỗi
            render.
          </p>
        </div>
      </div>
